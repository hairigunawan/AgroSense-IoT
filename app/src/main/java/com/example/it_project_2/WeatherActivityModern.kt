...
class WeatherActivityModern : AppCompatActivity() {
    ...
    private fun fetchLocationAndWeather() {
        ...
        val latitude = -3.792417
        val longitude = 114.808528
    ...
    private fun updateUI(data: WeatherApiResponse) {
        ...
        binding.tvCondition.text = com.example.it_project_2.utils.WeatherThemeEngine.translateCondition(data.current.condition.text)
        ...
        // Description
        binding.tvDescription.text = "Kondisi saat ini: ${com.example.it_project_2.utils.WeatherThemeEngine.translateCondition(data.current.condition.text)} dengan suhu $currentTemp°C."
